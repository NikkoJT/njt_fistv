...
<br/>
A player inside the FISTV can use the action menu to call for support. The observer turret can be accessed using a UAV terminal, which is provided in the vehicle inventory.
<br/><br/>
